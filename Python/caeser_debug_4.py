...
def decryptMessage(message, cipherKey, alphabet):
    ...
    return encryptMessage(message, decryptKey, alphabet) # Fix: return decrypt key 
...
def runCaesarCipherProgram():
    ...
    print(f'Decrypted Message: {myDecryptedMessage}') # error: code prints out encrypted message
